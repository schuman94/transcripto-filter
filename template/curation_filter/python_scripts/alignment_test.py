...
class Alignment_Test(Alignment):
    def __init__(self, frame_sequence: str, ref_sequence: str):
        ...
        ref_id = "Ref"
        params = {
            'porcentaje_minimo_coincidencia': 0.4,  # Asignar valores por defecto según necesidad
            'longitud_minima_subseq': 8,         # Asignar valores por defecto según necesidad
            'porcentaje_minimo_coincidencia_estricto': 0.5,  # Asignar valores por defecto según necesidad
            'longitud_minima_subseq_estrica': 3,  # Asignar valores por defecto según necesidad
            'future_elements': 8,  # Asignar valores por defecto según necesidad
            'longitud_minima_total_subseqs': 25,  # Asignar valores por defecto según necesidad
            'ratio_minimo_longitud': 0.5  # Asignar valores por defecto según necesidad
        }
...
frame = "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------MAMFLFI-------LICILTVTEGLR-----------------------------SQADCAD---TQMNG-QCDVCQISKKVWYSDRLLKNCTD-QYCSCSTPERN---FYAEDLMSN-PTKTYWFTVCCSDWTECVDTDIAV---TEPDV---SGLKRE------------------------------VAVRHKLQEKITFLGS-FIWRSAF*-----------------------"
ref = "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------MARFLSI-------LLCI-AVAVALA-----------------------------AGRRYPD----RPIG-RCETNDISKTEVYSNRFGKWVSGYTYCTCASGEEH---FAAEDTTSS-STGPYKIYVCGAPASPCSGATIPV---TDSDD----GTRR---------------------------------MECTCGQYKYFVSNRLGWHV-------------RCK----------"
